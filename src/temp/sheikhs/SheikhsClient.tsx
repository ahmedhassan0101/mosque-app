...
import type { SheikhWithGroups } from "@/types/serialized";
        ...
        <div className="relative z-10 flex items-center gap-3 w-full sm:w-auto">
          <div className="relative flex-1 sm:w-64">
            ...
            <Input
              ...
              className="pr-9 bg-white border-emerald-100 focus-visible:ring-primary rounded-xl"
            />
          </div>
          <Button
            asChild
            className="bg-primary/90 hover:bg-emerald-700 text-white rounded-xl shadow-sm shadow-emerald-200"
          >
        ...
        <div className="text-center py-20 bg-white border border-dashed border-emerald-200 rounded-2xl flex flex-col items-center justify-center">
          ...
          <p className="text-sm text-muted-foreground mt-1">
            {search
              ...
              : "لا يوجد مشايخ مسجلون بعد. ابدأ بإضافة شيخ جديد."}
          </p>
        </div>
      ) : (
