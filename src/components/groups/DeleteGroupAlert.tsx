// src/components/groups/DeleteGroupAlert.tsx
"use client";
...
export function DeleteGroupAlert({
  ...
  const handleDelete = () => {
    startTransition(async () => {
      const result = await deleteGroup(id, type);
      ...
      if (redirectAfterDelete) router.push(`/dashboard/groups/${type}`);
    });
  };
      ...
      <AlertDialogContent dir="rtl">
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="text-right">
            ...
            <br />
            سيتم إزالة هذا النشاط من سجلات جميع الطلاب المقيّدين. لا يمكن
            التراجع.
          </AlertDialogDescription>
        </AlertDialogHeader>
