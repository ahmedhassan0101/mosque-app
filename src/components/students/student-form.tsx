      ...
      >
        <Card>
          ...
          <CardContent className="flex flex-col gap-4">
            ...
            {/* Not a "related pair" like date/time — each gets its own row */}
        ...
        <Card>
          <CardHeader divider className="flex-row items-center justify-between">
            <SectionTitle icon={Users}>بيانات أولياء الأمور</SectionTitle>
            <CardAction>
              <Button
                type="button"
                variant="outline"
          ...
          <CardContent className="flex flex-col gap-4">
            {fields.map((field, index) => (
              <div
                key={field.id}
                className="grid grid-cols-1 gap-4 rounded-md bg-muted/50 p-4 md:grid-cols-2"
              >
                <FormInput
                  control={form.control}
        ...
        <Card>
          <CardHeader divider>
            <SectionTitle icon={BookOpen}>متابعة الحفظ</SectionTitle>
          </CardHeader>
          <CardContent>
            {/* Related pair — surah + ayah together specify one Quran position */}
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <FormSelect
                control={form.control}
                name="currentSurah"
