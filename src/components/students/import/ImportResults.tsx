// src/components/students/import/ImportResults.tsx
...
/**
 * Displays the import operation summary and per-row error details.
 * Server-friendly — no client hooks needed.
 */
      ...
      <div className="grid grid-cols-2 gap-3 p-4">
        <div className="flex items-center gap-3 p-4 rounded-lg bg-success/10 border border-success/20">
          ...
          <div>
            ...
            <p className="text-2xl font-bold text-foreground">{inserted}</p>
          </div>
        </div>
        ...
        <div className="border-t border-border">
          <div className="px-4 py-2.5 bg-muted/40">
            <h4 className="text-xs font-semibold text-muted-foreground uppercase tracking-wide">
              تفاصيل الأخطاء — حسب رقم الصف في ملف Excel
            </h4>
          </div>
          ...
          <div className="max-h-64 overflow-y-auto divide-y divide-border">
            {errors.map((e) => (
              ...
              >
                <span className="inline-block px-2 py-0.5 rounded text-[10px] font-bold bg-destructive/15 text-destructive mb-1.5">
                  الصف {e.row}
                </span>
