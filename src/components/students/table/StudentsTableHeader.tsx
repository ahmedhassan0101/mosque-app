// src/components/students/StudentsTableHeader.tsx
"use client";
  ...
  return (
    <TableHeader>
      <TableRow className="bg-muted/40 hover:bg-muted/40">
        {/* Sortable: Name */}
        <TableHead className="text-start pe-4">
          <button
            onClick={() => onSort("name")}
        ...
        <TableHead className="text-start text-xs font-medium text-muted-foreground">
          المستوى
        </TableHead>
        <TableHead className="text-start text-xs font-medium text-muted-foreground">
          الأنشطة
