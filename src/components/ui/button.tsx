  ...
  ].join(" "),
  {
    variants: {
      variant: {
        ...
        outline:
          "border-input bg-transparent hover:bg-muted hover:text-foreground dark:border-input dark:bg-transparent dark:hover:bg-muted/40",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary/70",
        ghost: "hover:bg-muted hover:text-foreground dark:hover:bg-muted/40",
        destructive:
