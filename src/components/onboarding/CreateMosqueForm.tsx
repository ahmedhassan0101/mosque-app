...
//   );
// }
// src/components/onboarding/CreateMosqueForm.tsx
"use client";
...
/*
  لا Card هنا — الفورم يعيش داخل TabsContent
  اللي هي جوه الـ Card الأم في OnboardingTabs.
  لو الفورم استخدم Card مرة ثانية → nested card مكرر.
*/
export function CreateMosqueForm() {
  const router = useRouter();
  const { update } = useSession();
